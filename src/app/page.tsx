      ...
      <main className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Earn Money with</span>
            <span className="block text-blue-600">EarnFlow</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Complete surveys, take offers, and earn real money. Join thousands of users already earning with EarnFlow.
          </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Complete surveys and earn points for each response.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Take special offers from our partners and earn rewards.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Cash out your earnings directly to your account.
                    </p>
                  </div>
                </div>
              </div>
